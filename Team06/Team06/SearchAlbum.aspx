<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/LonghornMusic.Master" CodeBehind="SearchAlbum.aspx.vb" Inherits="Team06.SearchAlbum" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="padding-top: 50px">
        <div class="page-header">
            <h1>Search Album<small> Enter criterias to search for albums</small></h1>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div align="center">
                    <div class="form-group">
                        ...
                        <label>Genre</label>
                        <asp:CheckBoxList ID="cblGenre" runat="server" Width="200px" AutoPostBack="True">
                        </asp:CheckBoxList>
                    </div>
                        </div>
                </div>
        ...
        <div class="col-md-12">
            <div align="center">
                ...
                <asp:Button ID="btnReset"  Text="Reset" runat="server" CssClass="btn btn-primary" type="submit" />
                <br />
